...
def plot_rates():
    ...
    joined = all_zips.join(rates_2019.set_index(['ZIP'], verify_integrity=True), on=['ZIP'], how='left')
    print(joined)
    # print(rates_2019['Prscrbr_Geo_Cd'])
    # print(cont_US_zips)
    # cont_US_zips.plot(ax=state_boundary_map, column='Opioid_Prscrbng_Rate')
    # plt.show()
